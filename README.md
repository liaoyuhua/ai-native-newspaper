...
深潜 AI 周刊每周扫描论文、实验室博客、开源项目与技术讨论，从噪声中选择一个近期出现真实技术增量的问题。随后追溯一手资料、拆解关键机制、核查事实，并用约 8～15 分钟的篇幅写成一篇有判断的短深文。

它不是资讯摘要，也不是论文清单。每一期只希望做好一件事：让读者带走一个更新后的技术世界模型。

<p align="center">
  <img src="docs/product-architecture.svg" width="100%" alt="深潜 AI 周刊从信号发现、编辑选题，经研究助理、主编和事实编辑协作，到每周短深文的产品架构" />
</p>
...
产品由一个精简的 AI 编辑部协作完成：研究助理追溯一手证据并拆解机制；主编决定叙事并完成整篇初稿；事实编辑只报告会误导读者的事实问题。没有阻断问题就直接发布；确有问题时，由主编做一次有限修订并作出最终决定。
